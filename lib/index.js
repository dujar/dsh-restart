...
/** The community plugins package this section can redirect into. */
const COMMUNITY_PACKAGE = 'dsh-community-plugins'
    ...
    handler: async (req, res) => {
      ...
      try {
        ...
        sendJson(res, 200, {
          ...
          community: {
            installed: Object.prototype.hasOwnProperty.call(deps, COMMUNITY_PACKAGE),
            enabled: bundles.includes(COMMUNITY_PACKAGE),
          },
        })
      } catch (error) {
