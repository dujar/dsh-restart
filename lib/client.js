...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var STYLES = [
        ...
        '.dshrt-git-danger{background:transparent;border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-danger,#e5534b);cursor:pointer;white-space:nowrap}',
        '.dshrt-git-danger:hover{border-color:var(--dsw-alias-danger,#e5534b)}',
        '.dshrt-git-danger-confirm{border-color:var(--dsw-alias-danger,#e5534b);background:color-mix(in srgb, var(--dsw-alias-danger,#e5534b) 12%, transparent)}',
        '.dshrt-uninstall{background:transparent;border:1px solid transparent;border-radius:6px;color:var(--dsw-alias-label-tertiary);font-size:11px;padding:2px 8px;cursor:pointer;font-family:inherit}',
        ...
        createElement('div', { className: 'dshrt-row-main' },
          ...
          plugin.link && !plugin.link.ok ? createElement('div', { className: 'dshrt-linkwarn' },
            ...
            createElement('button', {
              ...
              disabled: relinkBusy,
              onClick: applyRelink,
            }, relinkBusy ? props.t('relinking') : props.t('relink')),
          ) : null,
          gitOpen && refs ? createElement('div', { className: 'dshrt-git' },
            ...
            createElement('div', { className: 'dshrt-git-actions' },
              ...
              }, gitBusy ? props.t('gitSwitching') : props.t('gitApply')),
            ),
            createElement('div', { className: 'dshrt-git-divider' }),
            createElement('div', { className: 'dshrt-git-row' },
              ...
              }, reinstallBusy ? props.t('reinstalling') : (reinstallConfirm ? (rSource === 'plugin' ? props.t('reinstallPluginConfirm') : props.t('reinstallConfirm')) : props.t('reinstall'))),
            ),
          ...
          createElement('div', { className: 'dshrt-row-meta' },
            ...
            }, uninstallBusy ? props.t('uninstalling') : (uninstallConfirm ? props.t('uninstallConfirm') : props.t('uninstall'))),
          ),
        ),
