  ...
  factory: (require) => {
    ...
    if (typeof document !== 'undefined' && !document.querySelector('style[data-dshrt-styles]')) {
      ...
      style.textContent = [
        ...
        '.dshrt-git-select{flex:1;min-width:0;background:var(--dsw-alias-input-bg,transparent);color:var(--dsw-alias-label-primary);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;padding:4px 8px;font-size:12.5px}',
    ...
    function PluginRow(props) {
      ...
      function applyReinstall() {
        ...
        props.api.reinstall(plugin.name, rSource === 'local' ? null : rSource).then(function (res) {
          ...
          if (res && res.ok) {
            setGitNotice({ kind: 'ok', text: props.t('reinstalled') })
            props.onNotice('ok', props.t('reinstalled') + ' ' + plugin.name)
            setRefs(null)
            props.onRefresh()
          } else {
        ...
        createElement('div', { className: 'dshrt-row-main' },
          ...
          gitOpen && refs ? createElement('div', { className: 'dshrt-git' },
            ...
            createElement('div', { className: 'dshrt-git-row' },
              ...
              }, reinstallBusy ? props.t('reinstalling') : (reinstallConfirm ? props.t('reinstallConfirm') : props.t('reinstall'))),
            ),
